module GOVUKDesignSystemFormBuilder
  module Builder
    ...
    #
    def govuk_submit(text = config.default_submit_button_text, warning: false, secondary: false, classes: nil, prevent_double_click: true, validate: config.default_submit_validate, disabled: false, button: config.default_submit_button_element, **kwargs, &block)
      Elements::Submit.new(self, text, warning: warning, secondary: secondary, classes: classes, prevent_double_click: prevent_double_click, validate: validate, disabled: disabled, button: button, **kwargs, &block).html
    end
